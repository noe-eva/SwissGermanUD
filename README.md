...
The folder [monotonicity_splits]() contains the splits used for the _Dialect Normalization_ experiments described in the paper _[On Biasing Transformer Attention Towards Monotonicity](https://github.com/ZurichNLP/monotonicity_loss)
